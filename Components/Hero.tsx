            ...
            <div className='md:flex flex-between gap-10 items-center'>
                ...
                <aside>
                    <div className='relative z-20'>
                        ...
                        <p className='text-sm text-slate-500 mt-2'>We want to be on each of your journeys seeking the satisfaction of seeing the incorruptible beauty of nature. We can help you on an adventure around the world in just one app.</p>
