...
const Features = () => {
    ...
    return (
        <div className='my-10 max-w-[1100px] md:mx-auto mx-10 relative'>
            <header className='flex justify-center' data-aos="fade-up">
                <div>
            ...
            <main className='grid md:grid-cols-3 grid-cols-1 items-center'>
                <div className='flex justify-center col-span-1'>
                    <Image src={img2} alt='left side image'  className='md:w-[500px] w-[300px] z-0 rotate-35' data-aos="fade-up-right"/>
